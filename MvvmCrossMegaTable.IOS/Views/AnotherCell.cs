...
{
    public class AnotherCell : MvxTableViewCell
    {
        private readonly UILabel _headingLabel;
        private readonly UILabel _subheadingLabel;

        public static readonly NSString Key = new NSString("AnotherCell");

        public AnotherCell(IntPtr handle)
            : base(handle)
        {
            ...
            this.DelayBind(() =>
            {
                var set = this.CreateBindingSet<AnotherCell, AnotherSubViewModel>();
